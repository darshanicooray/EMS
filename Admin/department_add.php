          ...
          <form enctype="multipart/form-data" class="form-horizontal" name="myform" method="post" action="">
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($nResults > 0) {
                ...
                $sql = "insert into  department (department_code,department_name,faculty_code) VALUES ('$department_code', '$department_Name','$faculty')";
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="department_code" class="form-control" id="inputPassword3" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Department Name</label>
                <div class="col-sm-10">
                  <input type="text" name="department_Name" class="form-control" id="inputPassword3" required>
                </div>
              </div>
              <div class="form-group row">
