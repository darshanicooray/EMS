...
function countGrades($marksData)
{
    $gradeCounts = array(
        'A+' => 0,
        'A'  => 0,
...
{
    public function generatePDF($marksData, $university, $subjectDetails, $numStudents, $gradeCounts)
    {
        $this->AddPage();
        ...
        $html = '<table border="1" style="width: 40%;">
                    <tr>
...
$gradeCounts = countGrades($marksData);
...
// Generate PDF with student marks data, university, subject, number of students, and grade counts
$pdf->generatePDF($marksData, $university, $subjectDetails, $numStudents, $gradeCounts);
