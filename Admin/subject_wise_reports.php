        ...
        <div class="content-wrapper">
            ...
            line-height: 1.0;">
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="submit" name="submit_button" class="btn btn-<?php echo $DeanStatus == '1' ? 'success' : 'danger'; ?> btn-sm" style="width: 20%;" <?php echo $DeanStatus == '1' ? 'disabled' : 'disabled'; ?>>
