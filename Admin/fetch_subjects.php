...
if (isset($_POST['semester'], $_POST['academic_year'], $_SESSION['EMP_Number'])) {
    $semester = $_POST['semester'];
    $academic_year = $_POST['academic_year'];
    $empNumber = $_SESSION['EMP_Number'];

    $query = "SELECT * FROM lecturer_subjects WHERE Lecturer='$empNumber' AND Intake='$academic_year' AND Semester='$semester' AND AR_approval='1'";
