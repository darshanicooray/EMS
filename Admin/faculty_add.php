          ...
          <form enctype="multipart/form-data" class="form-horizontal" name="myform" method="post" action="">
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($nResults > 0) {
                ...
                $sql = "insert into  faculty (faculty_code,faculty_name) VALUES ('$faculty_code','$faculty_name')";
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="faculty_code" class="form-control" id="inputPassword3" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Faculty Name</label>
                <div class="col-sm-10">
                  <input type="text" name="faculty_name" class="form-control" id="inputPassword3" required>
                </div>
              </div>
            </div>
            <!-- /.card-body -->
