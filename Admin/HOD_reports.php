        ...
        <div class="card card-info">
          ...
          <form enctype="multipart/form-data" class="form-horizontal" name="myform" method="get" action="">
            <div class="card-body">
              ...
              $query = "SELECT Department FROM employee WHERE EMP_Number = '$employeeNumber'";
              $result = mysqli_query($conn, $query);
              ...
              if ($result) {
                ...
                // Handle error
                $departmentCode = ""; // Set default value or handle error
              }

              // Use $departmentCode as needed
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <select class="form-control" name="degree" onchange="loadSubjects()">
                    <option value="" selected="selected">-- Please Select --</option>
                    <?php
                    $query = "SELECT * FROM degree where department_code= '$departmentCode'";
                    $result = mysqli_query($conn, $query);
                    while ($row = mysqli_fetch_array($result)) {
                ...
                <tbody>
                  ...
                  ?>
                        <tr class="selectable-row">
                          ...
                          <td>
                            <a href="HOD_reports_vew.php?Subject_Code=<?php echo $Subject_Code ?>&Intake=<?php echo $Intake ?>&Semester=<?php echo $Semester ?>" class="btn btn-block btn-primary btn-sm">Detail Report</a>
                          </td>
