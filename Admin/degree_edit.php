      ...
      <section class="content">
        ...
        <div class="card card-info">
          ...
          if (isset($_POST['submit'])) {
            ...
            $qryUpdate = "UPDATE degree SET Degree_Name='$Degree_Name', department_code = '$department' WHERE id='$id'";
          ...
          $qty = mysqli_query($conn, "SELECT * FROM degree WHERE id='$id'");
          $row_qry = mysqli_fetch_array($qty);
          $r_id = $row_qry['id'];
          $r_Degree_Name = $row_qry['Degree_Name'];
          ...
          <form class="form-horizontal" enctype="multipart/form-data" method="post">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Degree_Code" id="inputEmail3" value="<?php echo $r_Degree_Code; ?>">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Degree Name</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Degree_Name" id="inputPassword3" value="<?php echo $r_Degree_Name; ?>">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="department">
                    <option value="<?php echo $r_department_code; ?>"><?php echo $r_department_code; ?></option>
                    <?php
