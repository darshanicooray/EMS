      ...
      <section class="content">
        ...
        <div class="card card-info">
          ...
          if (isset($_POST['submit'])) {
            ...
            $sql = "SELECT * FROM semester where Semester='$Semester' ";
            ...
            if ($nResults > 0) {
              ...
              $qryUpdate = "UPDATE semester SET Semester='$Semester' WHERE id='$id'";
          ...
          $qty = mysqli_query($conn, "SELECT * FROM semester WHERE id='$id'");
          ...
          <form class="form-horizontal" enctype="multipart/form-data" method="post">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Semester" id="inputPassword3" value="<?php echo $r_Semester; ?>">
                </div>
              </div>
            </div>
            <!-- /.card-body -->
