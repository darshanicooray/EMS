                ...
                <tbody>
                  ...
                  ?>
                        <tr class="selectable-row">
                          ...
                          <td>
                            <a href="lecturer_reports_vew.php?Subject_Code=<?php echo $Subject_Code ?>&Intake=<?php echo $Intake ?>&Semester=<?php echo $Semester ?>" class="btn btn-block btn-primary btn-sm">Detail Report</a>
                          </td>
