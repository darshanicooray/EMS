    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Map Subjects and lecturers</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="data-table">
                  ...
                  <table id="example3" class="table table-bordered ">
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT * FROM employee where user_type='Lecturer'";
                      $result = mysqli_query($conn, $query);
                      while ($row = mysqli_fetch_array($result)) {
              ...
              <h5>Lecturers and Subjects Mapping Details </h5>
              <table id="example2" class="table table-bordered ">
                ...
                <tbody>
                  <?php
                  $query = "SELECT * FROM lecturer_subjects";
                  $result = mysqli_query($conn, $query);
                  while ($row = mysqli_fetch_array($result)) {
    ...
    $(function() {
      ...
      $('#example1 tbody').on('click', 'tr', function() {
        ...
        if (rowData) {
          ...
          var selectedDegree_Code = rowData[4];
          ...
          selectedSubjectsIDs.push({
            ...
            Degree_Code: selectedDegree_Code
          });
        }
      });
