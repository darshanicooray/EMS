...
function getStudentMarksData($subjectCode, $Intake, $Semester)
{
    ...
    $query = "SELECT RegNum, AssignmentMarks, FinalMarks, TotalMarks, Grade FROM marks WHERE SubjectCode = '$subjectCode' AND Intake = '$Intake' AND Semester = '$Semester'ORDER BY Grade  ASC";
    $result = mysqli_query($conn, $query);
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                ...
                <div class="card card-info">
                    ...
                    <form enctype="multipart/form-data" class="form-horizontal" name="myform" method="post" action="">
                        ...
                        if (isset($_POST['submit_button'])) {
                            // Update Lecturestatus and HODsStatus to 1 in the comments table
                            $updateQuery = "UPDATE comments SET  DeansStatus = '1' WHERE Subject_Code = '$subjectCode' AND year = '$Intake' AND Semester = '$Semester'";
                            $retval = mysqli_query($conn, $updateQuery);
            ...
            Successfully Marks submitted
                        ...
                        $DeanStatus = isset($row) ? $row['DeansStatus'] : '';
                        ?>
            ...
            line-height: 1.0;">
                            ...
                            <div style="text-align: center;">
                                <button type="submit" name="submit_button" class="btn btn-<?php echo $lectureStatus == '1' ? 'success' : 'danger'; ?> btn-sm" style="width: 20%;" <?php echo $lectureStatus == '1' ? 'disabled' : 'disabled'; ?>>
                                    <?php echo $lectureStatus == '1' ? 'Submitted' : 'Lecturer Not Submitted'; ?>
                                </button>
                                <button type="submit" name="submit_button" class="btn btn-<?php echo $HODsStatus == '1' ? 'success' : 'danger'; ?> btn-sm" style="width: 20%;" <?php echo ($HODsStatus == '1' || $lectureStatus !== '1') ? 'disabled' : ''; ?>>
                                    <?php echo $HODsStatus == '1' ? 'HOD Approved' : 'HOD Not Approved'; ?>
                                </button>

                                <button type="submit" name="submit_button" class="btn btn-<?php echo $DeanStatus == '1' ? 'success' : 'danger'; ?> btn-sm" style="width: 20%;" <?php if ($DeanStatus == '1') echo 'disabled'; ?>>
                                    <?php echo $DeanStatus == '1' ? 'DEAN Approved' : 'DEAN Not Approved'; ?>
                                </button>
