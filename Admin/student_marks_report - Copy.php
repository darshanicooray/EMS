...
class StudentMarksPDF extends TCPDF
{
    public function generatePDF($marksData, $university, $subjectDetails, $numStudents)
    {
        ...
        $this->Cell(50, 8, 'Assignment Allocation:', 0, 0);
        $this->Cell(50, 8, $subjectDetails['Assignment_allo'] . '%', 0, 1);
        $this->Cell(50, 8, 'Final Allocation:', 0, 0);
        $this->Cell(50, 8, $subjectDetails['Final_allo'] . '%', 0, 1);
        ...
        $html = '<table border="1">
                    <tr>
                        ...
                        <th style="text-align:center;">Final Marks</th>
        ...
        foreach ($marksData as $row) {
            $html .= '<tr>
                        ...
                        <td style="text-align:center;">' . $row['FinalMarks'] . '</td>
