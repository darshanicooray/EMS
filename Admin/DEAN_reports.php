        ...
        <div class="card card-info">
          ...
          <form enctype="multipart/form-data" class="form-horizontal" name="myform" method="get" action="">
            <div class="card-body">
              ...
              $employeeNumber = $_SESSION['EMP_Number'];

              // Query the database to get department code
              $query = "SELECT faculty_code FROM employee WHERE EMP_Number = '$employeeNumber'";
              $result = mysqli_query($conn, $query);
              ...
              if ($result) {
                ...
                // Handle error
                $faculty_code = ""; // Set default value or handle error
              }

              // Use $faculty_code as needed
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  ...
                  <label class="form-check-label" name="faculty"><?php echo $faculty_code; ?></label>
                </div>
              </div>
              <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Department </label>
                <div class="col-sm-2">
                  <select class="form-control" name="department" onchange="loaddegree()">
                    <option value="" selected="selected">-- Please Select --</option>
                    <?php

                    $query = "SELECT * FROM department where faculty_code= '$faculty_code'";
                    $result = mysqli_query($conn, $query);
              ...
              <table id="example2" class="table table-bordered ">
                ...
                <tbody>
                  <?php
                  // Check if the indexes are set before using them in the query
                  ...
                  ?>
                        <tr class="selectable-row">
                          ...
                          <td>
                            <a href="DEAN_reports_vew.php?Subject_Code=<?php echo $Subject_Code ?>&Intake=<?php echo $Intake ?>&Semester=<?php echo $Semester ?>" class="btn btn-block btn-primary btn-sm">Detail Report</a>
                          </td>
