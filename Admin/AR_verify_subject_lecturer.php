      ...
      <section class="content">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">Verify lecturer and subject mapping</h3>
          </div>
          ...
          <form enctype="multipart/form-data" class="form-horizontal" name="myform" method="GET" action="">
            <div class="card-body">
              ...
              <div class="data-table">
                <table id="example2" class="table table-bordered ">
                  ...
                  <tbody>
                    <?php
                    if (isset($_GET['degree'], $_GET['Academic_Year'], $_GET['Semester'])) {
                      $query = "SELECT * FROM lecturer_subjects WHERE 
            ...
            <?php
            // Existing PHP code to handle form submission
            if (isset($_POST['approve'])) {
              // Process the form submission to update the specific record
              $row_id = $_POST['row_id'];
